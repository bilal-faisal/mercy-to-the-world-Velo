///////////////////////////////
///// this is the latest 30 nights page 2025;
///////////////////////////////

import { generateDailyChargesRamadan } from "backend/calculate30Ramdan.jsw"
...
async function distributionResult() {
    ...
    //     distribution = "All on 27th Night";
    // } else if (splitDropdownIndex == 3) {
    //     distribution = "split Equally All odds night"
    // } else if (splitDropdownIndex == 4) {
    //     distribution = "All on 21st Night"
    // } else if (splitDropdownIndex == 5) {
    //     distribution = "All on 23rd Night"
    // } else if (splitDropdownIndex == 6) {
    //     distribution = "All on 25th night"
    // } else if (splitDropdownIndex == 7) {
    //     distribution = "All on 29th Night"
    // }
    ...
    const result = await generateDailyChargesRamadan(total, startDate, distribution, thirtiethNight);
    console.log("result: ");
    console.log(result);
        ...
        $w('#checkouts4').onClick(() => {
            ...
            if (shouldCheckoutSingle) {
                ...
                let customerDetails = {
                    ...
                    plan: "30 Nights Single Donation"
                };
...
function getRamadanRadioOptions(ramadanStartDate) {
    ...
    if (remainingDays > 0) {
        dynamicOptions.push({ label: "Split Equally All odds night", value: "split Equally All odds night" });
